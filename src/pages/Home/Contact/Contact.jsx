                ...
                <div className='flex lg:flex-row flex-col items-center gap-10 xl:mx-0 mx-5'>
                    ...
                    <div className='w-full'>
                        ...
                        <div className='mt-20 space-y-4'>
                            <p className='text-white'><span className='text-primaryColor-200'>Call Me:</span> +880 1839-319088</p>
                        ...
                        <div className='mt-10'>
                            <form onSubmit={handleSubmit(onSubmit)}>
                                ...
                                <input className='rounded-md px-7 py-3 text-base font-medium text-white bg-primaryColor-200 hover:bg-primaryColor-200 hover:bg-opacity-5 hover:text-primaryColor-200 duration-200 cursor-pointer mt-5' type="submit" value={'Send Message'} />
                            </form>
                        </div>
                    </div>
                </div>
