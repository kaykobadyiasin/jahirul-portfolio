...
import { ArrowsDownUp, CalendarBlank, Crown, Cube, DotsThreeOutline, Pencil, Trash } from 'phosphor-react'
...
const ManageBlog = () => {
    ...
    const handleUpdate = (existId) => {
        ...
        const silgeExist = blogs.find(item => item._id == existId)
    ...
    return (
        <div>
            <div className=''>
                <h3 className='text-lg font-semibold py-2 px-5 bg-primaryColor-300 rounded-md'>{!existingId ? 'Add Blog' : 'Update Blog'}</h3>
                ...
                <form onSubmit={handleSubmit(onSubmit)}>
                    ...
                    <div className="flex justify-end mt-5">
                        <button
                            ...
                            type="submit"
                        >
                            {!existingId ? 'Add Blog' : 'Update Blog'}
                        </button>
                    </div>
                </form>
                <Toaster
                    ...
                    <Table.Caption>
                        <div className="my-5 flex items-center justify-between px-6">
                            <div className="flex items-center gap-5">
                                <p className="text-body-1 font-semibold text-metal-600">Manage blogs</p>
                            </div>
                        </div>
                    </Table.Caption>
                    <Table.Head>
